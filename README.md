...
- [Kubernetes Bootcamp (CKAD)](#kubernetes-bootcamp--ckad-)
  * [Learning Outcomes](#learning-outcomes)
    + [Ace the CKAD Exam](#ace-the-ckad-exam)
    + [How will this work?](#how-will-this-work-)
    + [I know Kubernetes already?](#i-know-kubernetes-already-)
    + [Exam curriculum](#exam-curriculum)
  * [Requirements](#requirements)
  * [1. Understanding and Using Containers](#1-understanding-and-using-containers)
    + [Basic docker commands](#basic-docker-commands)
    + [Lab 1.1. Hello docker](#lab-11-hello-docker)
    + [Lab 1.2. First container interaction](#lab-12-first-container-interaction)
    + [Lab 1.3. Entering and exiting containers](#lab-13-entering-and-exiting-containers)
    + [Lab 1.4. Container arguments](#lab-14-container-arguments)
    + [Managing containers and images](#managing-containers-and-images)
    + [Lab 1.5. Container ports and IP](#lab-15-container-ports-and-ip)
    + [Lab 1.6. Container volumes](#lab-16-container-volumes)
    + [Lab 1.7. Container environment variables](#lab-17-container-environment-variables)
    + [Lab 1.8. Container registries](#lab-18-container-registries)
  * [2. Managing Container Images](#2-managing-container-images)
    + [Lab 2.1. Working with images](#lab-21-working-with-images)
    + [Lab 2.2. Custom images](#lab-22-custom-images)
    + [Dockerfile overview](#dockerfile-overview)
    + [Lab 2.3. Create image from Dockerfile](#lab-23-create-image-from-dockerfile)
    + [Lab 2.4. Containerise your application](#lab-24-containerise-your-application)
    + [Docker container access control](#docker-container-access-control)
      - [UID and GID](#uid-and-gid)
      - [Capabilities](#capabilities)
      - [Running containers as non-root](#running-containers-as-non-root)
    + [Lab 2.5. Container privileges](#lab-25-container-privileges)
    + [Task - Docker image](#task---docker-image)
  * [3. Understanding Kubernetes](#3-understanding-kubernetes)
    + [Lab 3.1. Kubernetes in Google Cloud](#lab-31-kubernetes-in-google-cloud)
    + [Basic Kubernetes API resources](#basic-kubernetes-api-resources)
    + [Lab 3.2. Explore Kubernetes API resources via Google Cloud](#lab-32-explore-kubernetes-api-resources-via-google-cloud)
  * [4. Kubernetes Lab Environment](#4-kubernetes-lab-environment)
    + [Use Docker Desktop](#use-docker-desktop)
    + [Use Minikube](#use-minikube)
      - [Install Minikube on macOS](#install-minikube-on-macos)
      - [Install Minikube on Windows WSL2](#install-minikube-on-windows-wsl2)
      - [Minikube commands](#minikube-commands)
    + [Lab 4.1. Setup minikube and kubectl](#lab-41-setup-minikube-and-kubectl)
    + [Lab 4.2. Explore Kubernetes API resources via Minikube](#lab-42-explore-kubernetes-api-resources-via-minikube)
  * [5. Pods](#5-pods)
    + [Managing Pods](#managing-pods)
    + [Lab 5.1. Creating Pods](#lab-51-creating-pods)
    + [Pod manifest file](#pod-manifest-file)
    + [Valid reasons for multi-container Pods](#valid-reasons-for-multi-container-pods)
    + [Lab 5.2. Managing Pods with YAML file](#lab-52-managing-pods-with-yaml-file)
    + [Lab 5.3. Init Containers](#lab-53-init-containers)
    + [Lab 5.4. Multi-container Pod](#lab-54-multi-container-pod)
    + [Lab 5.5. Sidecar Containers](#lab-55-sidecar-containers)
    + [Using namespaces](#using-namespaces)
    + [Lab 5.6 Namespaces](#lab-56-namespaces)
    + [Task - Pods](#task---pods)
    + [Task - Pods II](#task---pods-ii)
  * [6. Exploring Pods](#6-exploring-pods)
    + [Debugging Pods](#debugging-pods)
    + [Lab 6.1 Troubleshoot failing Pod](#lab-61-troubleshoot-failing-pod)
    + [Ephemeral containers](#ephemeral-containers)
    + [Port forwarding](#port-forwarding)
    + [Lab 6.2. Use port forwarding to access applications](#lab-62-use-port-forwarding-to-access-applications)
    + [Security context](#security-context)
    + [Lab 6.3. Set Pod security context](#lab-63-set-pod-security-context)
    + [Jobs](#jobs)
    + [Lab 6.4. Working with Jobs](#lab-64-working-with-jobs)
    + [CronJobs](#cronjobs)
    + [Lab 6.5. Working with CronJobs](#lab-65-working-with-cronjobs)
    ...
    + [Lab 6.6. Resource limitation](#lab-66-resource-limitation)
    + [Lab 6.7. Resource allocation and usage](#lab-67-resource-allocation-and-usage)
    + [Task - CronJobs](#task---cronjobs)
    + [Task - Resources and Security Context](#task---resources-and-security-context)
  * [7. Deployments](#7-deployments)
    + [Lab 7.1. Deploy an app with a replicaset](#lab-71-deploy-an-app-with-a-replicaset)
    + [Lab 7.2. Scale deployment](#lab-72-scale-deployment)
    + [Labels, selectors and annotations](#labels--selectors-and-annotations)
    + [Lab 7.3. Working with labels](#lab-73-working-with-labels)
    + [Update strategy](#update-strategy)
    + [Lab 7.4. Rolling updates](#lab-74-rolling-updates)
    + [DaemonSets](#daemonsets)
    + [Lab 7.5. Exploring DaemonSets](#lab-75-exploring-daemonsets)
    + [Lab 7.6. Resource usage and Autoscaling](#lab-76-resource-usage-and-autoscaling)
    + [Task - Deployment](#task---deployment)
  * [8. Networking](#8-networking)
    + [Service](#service)
      - [Service Types](#service-types)
      - [Discovering services](#discovering-services)
    + [Lab 8.1. Connecting applications with services](#lab-81-connecting-applications-with-services)
    + [Lab 8.2. Connect a frontend to a backend using services](#lab-82-connect-a-frontend-to-a-backend-using-services)
    + [Task - Service](#task---service)
    + [Task - Service II](#task---service-ii)
  * [9. Ingress](#9-ingress)
    + [Lab 9.1 Enable Ingress](#lab-91-enable-ingress)
    + [Ingress Types](#ingress-types)
    + [Lab 9.2 Understanding ingress](#lab-92-understanding-ingress)
    + [Lab 9.3. Simple fanout Ingress](#lab-93-simple-fanout-ingress)
    + [Ingress rules](#ingress-rules)
    + [Path types](#path-types)
    + [Ingress Class](#ingress-class)
    + [Lab 9.4. Multiple hosts ingress](#lab-94-multiple-hosts-ingress)
    + [Network policies](#network-policies)
    + [Lab 9.5. Declare network policy](#lab-95-declare-network-policy)
    + [Task - Ingress](#task---ingress)
    + [Task - Network policy](#task---network-policy)
  * [10. Storage](#10-storage)
    + [Access modes](#access-modes)
    + [PV and PVC attributes](#pv-and-pvc-attributes)
    + [Storage Class](#storage-class)
    + [Lab 10.1. PVs and PVCs](#lab-101-pvs-and-pvcs)
    + [Lab 10.2. Configuring Pods storage with PVs and PVCs](#lab-102-configuring-pods-storage-with-pvs-and-pvcs)
    + [Task - Persistent volumes](#task---persistent-volumes)
  * [11. Variables, ConfigMaps and Secrets](#11-variables--configmaps-and-secrets)
    + [Variables](#variables)
    + [Lab 11.1. Deployment variables](#lab-111-deployment-variables)
    + [ConfigMaps](#configmaps)
    + [Lab 11.2. ConfigMaps as environment variables](#lab-112-configmaps-as-environment-variables)
    + [Lab 11.3. Mounting ConfigMaps](#lab-113-mounting-configmaps)
    + [Secrets](#secrets)
      - [Uses of secrets](#uses-of-secrets)
    + [Lab 11.4. Decoding secrets](#lab-114-decoding-secrets)
    + [Lab 11.5. Secrets as environment variables](#lab-115-secrets-as-environment-variables)
    + [Lab 11.6. Secrets as files](#lab-116-secrets-as-files)
    + [Lab 11.7. Secrets as docker registry credentials](#lab-117-secrets-as-docker-registry-credentials)
    + [Task - ConfigMap and Secrets](#task---configmap-and-secrets)
  * [12. Pod Lifecycle and Update Strategies](#12-pod-lifecycle-and-update-strategies)
    + [Pod states](#pod-states)
    + [Pod phase](#pod-phase)
    + [Container probes](#container-probes)
      - [Types of probe](#types-of-probe)
    + [Lab 12.1. Liveness probe](#lab-121-liveness-probe)
    + [Configure probes](#configure-probes)
    + [Lab 12.2. Readiness probe](#lab-122-readiness-probe)
    + [Lab 12.3. Protect slow starting containers with startup probe](#lab-123-protect-slow-starting-containers-with-startup-probe)
    + [Lab 12.4. Blue/Green deployments](#lab-124-blue-green-deployments)
    + [Lab 12.5. Canary deployments](#lab-125-canary-deployments)
    + [Task - Probes](#task---probes)
    + [Task - Zero Downtime Updates](#task---zero-downtime-updates)
  * [13 K8s API](#13-k8s-api)
    + [Understanding the API](#understanding-the-api)
      - [kube-apiserver](#kube-apiserver)
      - [kube-proxy](#kube-proxy)
    + [Directly accessing the REST API](#directly-accessing-the-rest-api)
    + [Lab 13.1. Using kubectl proxy to access the API](#lab-131-using-kubectl-proxy-to-access-the-api)
    + [Checking API access](#checking-api-access)
    + [Service Accounts](#service-accounts)
    + [Lab 13.2. Accessing the API without kubectl proxy](#lab-132-accessing-the-api-without-kubectl-proxy)
    + [Lab 13.3. Accessing the API from inside a Pod](#lab-133-accessing-the-api-from-inside-a-pod)
    + [RBAC](#rbac)
    + [ServiceAccount permissions](#serviceaccount-permissions)
    + [Lab 13.4. Exploring RBAC](#lab-134-exploring-rbac)
    + [Task - Service account](#task---service-account)
  * [14. DevOps](#14-devops)
    + [Helm](#helm)
    + [ArtifactHUB](#artifacthub)
    + [Lab 14.1. Explore Helm Charts](#lab-141-explore-helm-charts)
    + [Helm templates](#helm-templates)
    + [Lab 14.2. Customising Helm Charts](#lab-142-customising-helm-charts)
    + [Kustomize](#kustomize)
    + [Lab 14.3. Kustomize resources](#lab-143-kustomize-resources)
    + [Custom Resource Definition (CRD)](#custom-resource-definition--crd-)
    + [Lab 14.4. Custom objects](#lab-144-custom-objects)
    + [Operator pattern](#operator-pattern)
    + [Lab 14.5. Operators](#lab-145-operators)
    + [StatefulSets](#statefulsets)
      - [Using StatefulSets](#using-statefulsets)
      - [Limitations of StatefulSets](#limitations-of-statefulsets)
    + [Lab 14.6. Components of a StatefulSet](#lab-146-components-of-a-statefulset)
    + [Task - Helm](#task---helm)
  * [15. Exam](#15-exam)
    + [Exam simulation](#exam-simulation)
    + [Environment setup](#environment-setup)
    + [Commandline copy-paste](#commandline-copy-paste)
    + [Text editor proficiency](#text-editor-proficiency)
